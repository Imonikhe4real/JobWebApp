...
public function dataviewapply($sql){
		...
		if($stmt->rowCount()>0)
		{
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
				...
				?>
     	 		...
     	 		<br><br><br>
     	 	 <a href="apply.php?id=<?php echo $row['id'];?>" class="btn btn-primary w3-pink" style="font-weight:bolder;">Click To Apply</a>   	 	
                  <br><br>
                <?php
			}
		}
	...
	public function pagingapply($sql,$records_per_page)
	{
		$starting_position=0;
	...
	public function paginglinkapply($sql,$records_per_page)
	{
...
public function fetch_singleapply($id){
